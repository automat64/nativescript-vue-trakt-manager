...
export default class Trakt {
    ...
    constructor() {
        ...
        this.clientId = 'ca9dff34914b04651bad7540e573ea6ba39c41e6d7e4772522b96119a62606a2';
        this.clientSecret
        this.traktAccessToken = localStorage.getItem('access_token');
        this.traktRefreshToken = localStorage.getItem('refresh_token');
        this.redirectUri = "traktns://authorize";
        this.traktUrl = "https://trakt.tv/oauth/authorize?response_type=code&client_id="+'ca9dff34914b04651bad7540e573ea6ba39c41e6d7e4772522b96119a62606a2'+"&redirect_uri="+this.redirectUri,
    ...
    async authorize(code) {
        ...
        return this.axiosTrakt({
            ...
            data: {
                code: code,
                client_id: 'ca9dff34914b04651bad7540e573ea6ba39c41e6d7e4772522b96119a62606a2',
                client_secret: 'cb43efe2160ba0a3a9602b4da0efbf33c97ffccccd1c238cc73c83eb82aeb478',
